...
root.title("𝓟𝓻𝓲𝓷𝓬𝓮𝓼𝓼 𝓢𝓬𝓲𝓮𝓷𝓽𝓲𝓯𝓲𝓬 𝓒𝓪𝓵𝓬𝓾𝓵𝓪𝓽𝓸𝓻")
...
# Entry field
entry = tkinter.Entry(root, font=("baskerville", 20, "bold"), bg="pink", fg="white", bd=10, width=30)
...
for i in button_list:
    # Buttons
    button = tkinter.Button(root, width=5, height=2, bd=2, text=i, bg="white", fg="pink",
                            font=("baskerville", 18, "bold"), command=lambda button=i: click(button))
