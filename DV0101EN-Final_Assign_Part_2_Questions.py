...
app.layout = html.Div([
    ...
    html.Div(id='output-container', className='chartg-grid', style={flex}),])
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
       nemp__data= recession_data.groupby(['Vehicle_Type','unemployment_rate'])['Automobile_Sales'].mean().reset_index()
